...
function CategoryOffers() {
  ...
  const params = useLocalSearchParams<BrokerParams>();
  const loadOffer = async () => {
    try {
      setLoading(true);
      const offerData = await loadOfferByBroker(params.id!);
      setData(offerData);
